...
int main() {
    ...
    const char *index_key = "IVF65536,PQ16";
    // const char *index_key = "OPQ16,IVF65536,PQ16";
...

    {
        ...
        size_t nt;
        float* xt = fvecs_read("/data/bigann/bigann_learn.bvecs", &d, &nt);
    ...
    faiss::write_index(index, "/data/trained_CPU_indexes_C/SIFT1000M_OPQ16,IVF65536,PQ16_trained_index");

    {
        printf("[%.3f s] Loading database\n", elapsed() - t0);

        size_t nb, d2;
        float* xb = fvecs_read("/data/bigann/bigann_base.bvecs", &d2, &nb);
    ...
    faiss::write_index(index, "/data/trained_CPU_indexes_C/SIFT1000M_OPQ16,IVF65536,PQ16_populated_index");
...

    {
        ...
        size_t d2;
        xq = fvecs_read("/data/bigann/bigann_query.bvecs", &d2, &nq);
...

    {
        ...
        size_t nq2;
        int* gt_int = ivecs_read("/data/bigann/gnd/idx_1000M.ivecs", &k, &nq2);
