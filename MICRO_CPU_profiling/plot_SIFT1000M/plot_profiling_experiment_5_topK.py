...
print("Warning: For SIFT1000M, this setting does not achieve 95% R@100 recall. I should have used another nprobe")
...
draw_profiling_plot(x_labels, y_stage_1_4, y_stage_5, y_stage_6, y_other, 'cpu_profile_experiment_5_topK_SIFT1000M', x_tick_rotation=45)
