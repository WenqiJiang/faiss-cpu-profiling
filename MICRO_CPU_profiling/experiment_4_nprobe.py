...
Example Usage:
    python experiment_4_nprobe.py --dbname SIFT1000M --index_key IVF65536,PQ16 --topK 100 --min_nprobe 1 --max_nprobe 128 --qbs 10000 --repeat_time 10 \
...
for nprobe in nprobe_list:
    ...
    os.system('echo ==== nprobe={nprobe} ==== >> {logname}'.format(nprobe=nprobe, logname=logname))
